var store = [{
        ...
        "excerpt":"What on Earth are Adobe up to? I found a random folder in my ~/.gitignore-boilerplates repo (created by gibo): james@Jamess-iMac: ~/.gitignore-boilerplates on master$ ls -ld */drwxr-xr-x 10 james staff 320 Apr 15 00:54 .git/drwxr-xr-x 3 james staff 96 Mar 17 15:09 .github/drwxr-xr-x 61 james staff 1952 Mar 17 15:09 Global/drwx------+...","categories": ["macOS"],
        ...
        "excerpt":"I had a shocker earlier with an out of control1 shell script that was supposed to tidy up a load of empty directories on my Mac. Just in my home dir I had nearly 18,000 empty directories: james@Jamess-iMac: ~$ find . -not \\( -name .svn -prune -o -name .git -prune...","categories": ["macOS"],
